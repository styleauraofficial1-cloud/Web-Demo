(function(window) {
  ...
  var require = function(mod) {
    if (mod === 'events') {
      ...
      EventEmitter.prototype.emit = function(e){ var a=Array.prototype.slice.call(arguments,1); (this._events[e]||[]).forEach(function(fn){fn.apply(this,a)},this); return this; };
      EventEmitter.prototype.off = function(e,fn){ this._events[e]=(this._events[e]||[]).filter(function(f){return f!==fn;}); return this; };
      EventEmitter.prototype.once = function(e,fn){ var self=this; function w(){ self.off(e,w); fn.apply(self,arguments); } this.on(e,w); return this; };
      return EventEmitter;
    }
    return {};
  };
...
exports.default = Vapi;
  ...
  window.Vapi = exports.default || module.exports.default || exports;
})(window);
